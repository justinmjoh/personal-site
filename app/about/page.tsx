export default function About() {
  return (
    ...
    <section className="border-2 border-black dark:border-white p-8 m-8">
      ...
      <p className="mt-4 text-lg">
        I am currently located in northern Maryland, and seeking opportunities nationwide. I am open to both remote work and relocating myself for the right opportunity. Please do not hesitate to <a href="mailto:justinmjoh@gmail.com" className="text-yellow-600 hover:underline">reach out</a> if you have any questions or would like to connect!
      </p>
    </section>
  </main>
  );
